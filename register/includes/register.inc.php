...
if (isset($_POST['signupsubmit'])) {
	...
	*/
	...
	$company = input_filter($_POST['company']);
	...
	*/
	...
	if (empty($username) || empty($email) || empty($password) || empty($passwordRepeat)) {
		...
		*/
		...
		$sql = "insert into users(username, email, password, first_name, last_name, company, is_admin,
		...
		if (!mysqli_stmt_prepare($stmt, $sql)) {
			...
			$is_admin = "false";
			mysqli_stmt_bind_param($stmt, "ssssssss", $username, $email, $hashedPwd, $full_name, $last_name, $company, $is_admin, $FileNameNew);
